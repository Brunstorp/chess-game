...
class Board:
    def __init__(self):
        ...
        self.pieces_set = set() # setup so we can keep track of all pieces on the board so we don't have to search for them all the time
    ...
    def setup(self):
        ...
        for i, col in enumerate('abcdefgh'):
            ...
            self.pieces_set.add(white_pawn)
            self.pieces_set.add(black_pawn)
            ...
            self.pieces_set.add(white_piece)
            self.pieces_set.add(black_piece)
    ...
    def is_square_safe(self, position: str, color: str) -> bool: #checks if a given square is safe for a given player to move to
    ...
    def get_piece_position(self, piece: P) -> str: # returns the position of a given piece
        self.pieces_set.get(piece)
